      ...
      <section className="space-y-4">
        ...
        <Card className="max-w-xl">
          ...
          <CardBody className="space-y-3 text-sm text-[var(--fg-muted)]">
            ...
            <p>
              The integration exposes on-site count, occupancy state, contractor totals, and flagged sessions. For test connectivity, use the <Link className="text-[var(--accent)] hover:underline" href="/simulate">Simulate</Link> page.
            </p>
          </CardBody>
        </Card>
      </section>
